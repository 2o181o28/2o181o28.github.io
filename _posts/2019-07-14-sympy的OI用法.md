...
参见[官方英文教程](https://docs.sympy.org/latest/tutorial/index.html#tutorial)和较老的[中文教程](http://www.asmeurer.com/sympy_doc/dev-py3k/tutorial/tutorial.zh.html)，可以代替Wolfram|Alpha的大部分功能。
