...
这篇文章姗姗来迟了。按照之前的[惯例](https://2o181o28.github.io/2018/12/22/Ubuntu18.10%E8%AF%95%E7%94%A8/)，我[升级Ubuntu系统至20.04](https://2o181o28.github.io/2020/05/02/Ubuntu%E5%8D%87%E7%BA%A7%E8%87%B320.04/)之后尝试了一下 C++20 的新语法。在`g++-10`和`clang++-10`中已经有了`-std=c++20`的编译选项，支持的 C++20 语法特性已经比一年前多了很多。现在我来由浅入深地总结一下自己觉得有用的内容。
...
这里还使用了 C++17 的模板参数类型自动推导，我在之前的[某篇洛谷日报](https://2o181o28.github.io/2018/12/01/%E6%B5%85%E8%B0%88valarray/)里面提到过。
...
我最近写了一篇文章：[C++编译期多项式exp](https://2o181o28.github.io/2020/03/13/C++%E7%BC%96%E8%AF%91%E6%9C%9F%E5%A4%9A%E9%A1%B9%E5%BC%8Fexp/)。那篇文章侧重于表达模板元编程的能力。下面我使用 constexpr 重写一份，同样是在编译期完成的：
```cpp
#include<bits/stdc++.h>
using namespace std;
using ll=long long;
