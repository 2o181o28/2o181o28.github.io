...
- virtualbox：虚拟机
	...
	- {:.New}Ubuntu 21.10：终端行间距超宽的Ubuntu 21.10
	- Windows 10: Windows 10
- {:.New}腾讯会议：腾讯会议，对没错这东西有Linux版了
- {:.New}Shotcut：视频剪辑软件，不要装默认源里的，会段错误
...
- {:.New}[GoAuthing](https://github.com/z4yx/GoAuthing)：连接清华WiFi无需认证
