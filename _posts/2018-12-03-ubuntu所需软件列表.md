...
===
- **chrome：浏览器**
	- {:.New}**[keep-manifest-v2](https://github.com/KiritoMiao/keep-manifest-v2)：保留我的Manifest V2吧**
	- **UBlock Origin：广告拦截**
	...
	- AdBlock Plus：之前用的广告拦截，但据说不如UBlock Origin好
...
- **steam：Steam**
	...
	- 暗黑地牢：现在DLC也买了
	- 雀魂：沉迷麻将不可自拔
	- Slay the Spire：和以撒差不多，现在沉迷尖塔不可自拔
- 洛雪音乐助手：本人是contributor之一，现在没啥音源了，我主要用Spotify
