...
- **TeXstudio：TeX**
- {:.New} Calibre: epub阅读器；但是20.04里的不能转换pdf，需要[改下代码](https://bugs.debian.org/cgi-bin/bugreport.cgi?att=1;bug=944875;filename=944875.patch;msg=20)
- wps：比libreoffice好用
...
- virtualbox：虚拟机
	...
	- {:.New}Ubuntu 22.04：终端行间距超宽的Ubuntu 22.04
	- Windows 10: Windows 10
- 腾讯会议：腾讯会议，对没错这东西有Linux版了
- Shotcut：视频剪辑软件，不要装默认源里的，会段错误
