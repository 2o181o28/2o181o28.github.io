...
- VS Code：功能很多的代码编辑器，不知道为什么那么多人用
...
- {:.New}MATLAB：付费版numpy+matplotlib
...
- **chrome：浏览器**
	...
	- TamperMonkey：运行用户脚本
		...
		- 网页限制解除：复制网页内容
		- 百度文库免费下载
		- {:.New}Tenhou-Pairi Kokei display：天凤牌理显示好型率
	- setupVPN：救急用的VPN
	...
	- {:.New} FireShot：网页截图工具，可以截取网页的特定部分和制作长截图
	- {:.New} Bypass Paywalls：免费浏览各种新闻网站
- **Clash for Windows：但是Linux能用；统一管理各种代理**
- {:.New}Tor Browser：Tor浏览器，现在是刚需，因为Z Library
...
- {:.New}wireshark：用来抓包，挺有意思的
- {:.New}aircrack-ng：用来在monitor mode下抓包
- {:.New}openconnect：连接清华VPN用
